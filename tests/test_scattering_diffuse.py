...
def test_diffuse_eyring():
    ...
    air_attenuation = pf.FrequencyData(np.tile([
        0.000652350693755930, 0.00111221984304401, 0.00226837553058824,
        0.00659994837403191, 0.0232464500602580, 0.0815039446237653,
        0.167026524991143], (4,1)), f)

    scattering_coefficient = ik.scattering.diffuse(
        reverb_time, speed_of_sound, air_attenuation, 'Eyring')
