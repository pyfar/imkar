...
5. When you're done making changes, check that your changes pass flake8 and the
   ...
   flake8 test must pass without any warnings for `./imkar` and `./tests` using the default or a stricter configuration. Flake8 ignores `E123/E133, E226` and `E241/E242` by default. If necessary adjust your flake8 and linting configuration in your IDE accordingly.
