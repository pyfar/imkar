...
Look through https://github.com/pyfar/imkar/issues for bugs or feature requests
...
Ready to contribute? Here's how to set up `imkar` for local development using the command-line interface.
...
5. When you're done making changes, check that your changes pass ruff and the
   ...
   ruff must pass without any warnings for `./imkar` and `./tests` using the default or a stricter
